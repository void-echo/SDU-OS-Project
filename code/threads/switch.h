...
#ifdef _WIN32
/* 
 * WARNING:  The following code is only used to make VSCode not warn about 
 * some `#define` statements in the following code.  It is not used in the project.
 * 
 * Void Echo, 2022/11/02
 */
#define SP 0
#define S0 4
#define S1 8
